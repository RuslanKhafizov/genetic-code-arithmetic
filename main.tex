...
null model of genetic codes and yields no $p$-value. Removing
duplicate values does not remove the dependencies induced by the
...
\texttt{prime\_divisibility\_scan.csv}. The first place of~$37$ in
the sets where divisibility is not imposed shows that its
distinction under the chosen metric is present before the derivation
of Key~1.
